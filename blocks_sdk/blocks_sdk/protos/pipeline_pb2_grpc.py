...
def add_PipelineServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Process': grpc.unary_unary_rpc_method_handler(
                    servicer.Process,
                    request_deserializer=pipeline_pb2.Envelope.FromString,
                    response_serializer=pipeline_pb2.Envelope.SerializeToString,
            ),
    }
...
class PipelineService:
    ...
    def Process(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/pipeline.PipelineService/Process',
            pipeline_pb2.Envelope.SerializeToString,
            pipeline_pb2.Envelope.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
