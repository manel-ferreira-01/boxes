...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in acquisition_pb2_grpc.py depends on'
...
def add_AcquisitionServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'AcquisitionService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('AcquisitionService', rpc_method_handlers)
...
class AcquisitionService(object):
    ...
    def acquire(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/AcquisitionService/acquire',
            acquisition__pb2.AcquireRequest.SerializeToString,
            acquisition__pb2.AcquireResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
