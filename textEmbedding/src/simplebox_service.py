...
def get_embeddings(input_data: Union[str, List[str]], model_name="all-MiniLM-L6-v2") -> Union[List[float], List[List[float]]]:
    """
    Generate embeddings for a single string or a list of strings using a SentenceTransformer model.
    
    Parameters:
        input_data (str or List[str]): Text or list of texts to embed.
